...
defbindings("WScreen", {
    ...
    --OM: switch between screens (usually screens are workspaces containing several app windows)
    kpress(META.."Z", "WScreen.switch_prev(_)"),
    kpress(META.."X", "WScreen.switch_next(_)"),
...
defbindings("WMPlex.toplevel", {
    ...
    -- OM: switch between frames (frames are usually application windows)
    kpress(META.."W", "WFrame.switch_next(_)"),
